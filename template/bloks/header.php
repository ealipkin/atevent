        ...
        <div class="header-left">
            <div>
                <ul>
                    ...
                    <li class="icon icon-phone"><a href="#" class="popup-link dashed" data-link="popup-callback">Заказать обратный звонок</a></li>
...
<nav class="main-menu">
    <ul>
        <li><a <?=('/at'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/at"'?> ><div class="main-menu-lead"></div><span>Ведущие</span></a></li>
        <li><a <?=('/artists'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/artists"'?>><div class="main-menu-artists"></div><span>Артисты</span></a></li>
        <li><a <?=('/auto'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/auto"'?>><div class="main-menu-auto"></div><span>Автомобили</span></a></li>
        <li><a <?=('/decorate'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/decorate"'?>><div class="main-menu-decorate"></div><span>Оформление</span></a></li>
        <li><a <?=('/photographs'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/photographs"'?>><div class="main-menu-photo"></div><span>Фото/видео</span></a></li>
        <li><a <?=('/cakes'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/cakes"'?>><div class="main-menu-cakes"></div><span>Торты</span></a></li>
        <li><a <?=('/places'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/places"'?>><div class="main-menu-restaraunts"></div><span>Рестораны</span></a></li>
        <li><a <?=('/other_services'==$_SERVER["REQUEST_URI"]) ? 'class="menu-active" href="#"' : 'href="/other_services"'?>><div class="main-menu-another"></div><span>Другие услуги</span></a></li>
    </ul>
</nav>
<!-- Модальные окна -->
