<h3 class="acc-header fl">Дорожки из фонтанов</h3>
<a href="other_services" class="fr">
	<button class="btn back-btn at-btn" type="button"><i class="icon-white icon-arrow-left"></i>
		Назад к услугам
	</button>
</a>
<hr class="acc-hr" />
<h5>Фото</h5>
<hr>
<?=getPhotoGalleryBlock('firework',2)?>
