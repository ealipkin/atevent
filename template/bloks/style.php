...
.vk-btn-head {
    background: url(../img/soc-btn-sprite.png) 0 0;
}

.youtube-btn-head {
    background: url(../img/soc-btn-sprite.png) -32px 0;
}

.insta-btn-head {
    background: url('../img/soc-btn-sprite.png') -64px 0;
}

.vk-btn-footer {
    background: url(../img/soc-btn-sprite.png) 0 32px;
    height: 32px !important;
}

.youtube-btn-footer {
    background: url('../img/soc-btn-sprite.png') -32px 32px;
    height: 32px !important;
}

.insta-btn-footer {
    background: url('../img/soc-btn-sprite.png') -64px 32px;
    height: 32px !important;
}
