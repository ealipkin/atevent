...
<h2>Редактирование информации о сувенирах</h2>
<input type="hidden" class="edit-table-type" data-table="souvenirs">
<?=getHairMakeupBlockEdit(0, 'souvenirs')?>
