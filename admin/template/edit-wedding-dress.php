<h2>Добавить новое свадебноe платье</h2>
<div class="">
	<form class="add-form">
		<div class="edit-info-block clearfix">
			<div class="edit-block column col-2 clearfix">
...
<h2>Редактирование информации о свадебных платьях</h2>
<input type="hidden" class="edit-table-type" data-table="wedding_dress">
<?=getWeddingDressBlockEdit()?>
