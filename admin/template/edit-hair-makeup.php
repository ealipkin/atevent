...
<h2>Редактирование информации "Прическа и макияж"</h2>
<input type="hidden" class="edit-table-type" data-table="hair_makeup">
<?=getHairMakeupBlockEdit()?>
