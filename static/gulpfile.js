...
// PUG
gulp.task('pug', ['pug-concat'], function() {
...
// JStemplate
gulp.task('pug-jstmpl', function() {
  return gulp.src('src/pug/jstmpl.pug')
  .pipe(pug({
    pretty: true
  }))
...
gulp.task('sass', function() {
  return gulp.src(['src/css/variables.scss','src/css/normalize.scss', 'src/css/vendor/*.scss', 'src/css/base.scss', 'src/blocks/base/**/*.scss', 'src/blocks/composite/**/*.scss', 'src/css/utils.scss'])
...
gulp.task('svg', function() {
  ...
  let source = gulp.src('src/img/svg/*.svg')
  .pipe(svgmin())
